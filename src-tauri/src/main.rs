...
const APP_NAME: &str = "TalkingStickies"; // name of the app. Can be changed without breaking your app.
const APP_ID: &str = "TalkingStickies"; // App id used to install your app in the Holochain conductor - can be the same as APP_NAME. Changing this means a breaking change to your app.
pub const WINDOW_TITLE: &str = "TalkingStickies"; // Title of the window
...
pub async fn install_app_if_necessary(
        ...
        .contains(&APP_ID.to_string())
    {
        ...
        let app_bundle = AppBundle::decode(include_bytes!("../../pouch/talking-stickies.happ"))
